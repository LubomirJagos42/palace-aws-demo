...
##########################################################################################################
gmsh.initialize()
gmsh.model.add("helical_antenna")
...
mesherObj.addStepfile("antenna", "stepfiles/helix_antenna_hexagonal_wire.step", priority=5000)
...
field_threshold_wire = mesherObj.setSurfaceMeshSize(["antenna"], 5.5, 20.0, 0.0, 5.0)
field_threshold_gnd = mesherObj.setSurfaceMeshSize(["gnd"], 2.0, 20.0, 0.0, 5.0)
...
simulationConfig["Solver"]["Linear"]["MaxIts"] = 300
