...
def polar_plots(data, label, filename="farfield_polar.png"):
    """
...
def main():
    ...
    polar_filename = f"farfield_polar.png"
    three_d_filename = f"farfield_3d.png"

    polar_plots(data, label, polar_filename)
    three_d_plot(data, label, three_d_filename)

    #
    # Export .vtk, .vtu for Paraview
    #
    three_d_plot_vtk_simple(data, label, f"farfield_3d.vtk")
    plot_vtk_surface(data, label, f"farfield_3d_sphere.vtk")
...
def plot_vtk_surface(data, label, filename="farfield_3d"):
    """
